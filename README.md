<div align="center">
  ...
  <p>Design shows in 3D. Calibrate moving heads with a $30 webcam. Run everything from a browser, a phone, or a gyro controller — without the cloud.</p>
  <p>
...
- **Unified mover control** — one engine drives DMX from a web slider, a phone's gyroscope, or a wall-mounted ESP32 gyro. Claim/release semantics so two operators never fight over the same beam.
...
| Web UI + phone + gyro controller | **Yes** | Proprietary hw | Proprietary hw | Web only |
